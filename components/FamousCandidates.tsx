...
const NOTABLE: {
...
}[] = [
  {
    ...
    district: 'Chennai · AC #19',
    won: true,
  },
  {
    name: 'Edappadi K. Palaniswami',
    label: 'ADMK Chief · Opposition Leader',
    party: 'ADMK',
    constituency: 'Edappadi',
    district: 'Salem · AC #86',
    won: true,
  },
  {
    name: 'Sowmiya Anbumani',
    label: "PMK · Dr. Anbumani's Daughter",
    party: 'PMK',
    constituency: 'Pennagaram',
    district: 'Dharmapuri · AC #59',
    won: true,
  },
  {
    name: 'Premallatha Vijayakant',
    label: "DMDK · Captain's Wife",
    party: 'DMDK',
    constituency: 'Alangulam',
    district: 'Tenkasi · AC #152',
    won: true,
  },
  {
    name: 'P K Sekarbabu',
    label: 'DMK · Cabinet Minister',
    party: 'DMK',
    constituency: 'Harbour',
    district: 'Chennai · AC #18',
    won: true,
  },
  {
    name: 'Nainar Nagenthran',
    label: 'BJP State President',
    party: 'BJP',
    constituency: 'Vellore South',
    district: 'Vellore · AC #32',
    won: false,
  },
]
