  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="2. Description of Service">
        <p>Tamil entertainment hub — serials, movies, music and more for the global Tamil diaspora.</p>
        <p className="mt-2">
      ...
      <Section title="5. Intellectual Property">
        <p>
          All original content, design and code on this service is owned by or licensed to NammaTamil.
