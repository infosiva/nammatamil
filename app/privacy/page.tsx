  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <Section title="1. Who We Are">
        <p>NammaTamil (https://nammatamil.live) is operated by an independent developer. Tamil entertainment hub — serials, movies, music and more for the global Tamil diaspora.</p>
