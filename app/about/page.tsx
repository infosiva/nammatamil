...
export const metadata: Metadata = {
  title: "About | NammaTamil",
  description: "About NammaTamil — Tamil entertainment hub — serials, movies, music and more for the global Tamil diaspora.",
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-16 text-sm leading-relaxed">
      ...
      <section className="mb-8">
        <p className="text-base leading-7">Tamil entertainment hub — serials, movies, music and more for the global Tamil diaspora.</p>
      </section>

      <section className="mb-8">
        <h2 className="text-lg font-semibold mb-3">What We Offer</h2>
        <p>
          NammaTamil is a free service built to make entertainment more accessible through the power of artificial intelligence.
